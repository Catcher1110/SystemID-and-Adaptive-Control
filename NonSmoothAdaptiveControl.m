function [X_dot, y] = NonSmoothAdaptiveControl(t, X)
    global a1 a2 c d wr psi mu a eJtheta L1 L2 Kp O1 O2 dt Gamma Phihat Phimin Phimax PhiBar sigma;
    ...
    PhiBar_dot = - Gamma * transpose(W) * s - sigma * (PhiBar - Phihat);
    PhiBar = PhiBar + PhiBar_dot * dt;
    Phihat = NonProjection(PhiBar, Phimin, Phimax);
