function [X_dot, y] = NonAdaptiveControl(t, X)
    global a1 a2 c d wr psi mu p1 p2 p3 a eJtheta L1 L2 Kp Phi O1 O2;
    ...
    tau = - Kp * s + Regressor(q, q_dot, qd_dot - error, qd_ddot - error_dot)*Phi;
