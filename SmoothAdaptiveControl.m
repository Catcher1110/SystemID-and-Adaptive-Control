function [X_dot, y] = SmoothAdaptiveControl(t, X)
    global a1 a2 c d wr psi mu a eJtheta L1 L2 Kp O1 O2 dt Gamma Phihat Phimin Phimax Eta;
    ...
    Eta_dot = - Gamma * transpose(W) * s;
    Eta = Eta + Eta_dot * dt;
    Phihat = SmoothProjection(Eta, Phimin, Phimax);
